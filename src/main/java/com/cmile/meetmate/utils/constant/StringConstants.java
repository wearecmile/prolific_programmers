...
public class StringConstants {
    ...
    public static final String REQUEST_FAILURE_MESSAGE_ATTENDANCE_NOT_UPDATED = "Failed to update Attendance";
    public static final String REQUEST_FAILURE_MESSAGE_NO_ATTENDANCE_FOUND = "No Attendance found";
    public static final String REQUEST_SUCCESS_MESSAGE_ATTENDANCE_RETRIEVED = "Attendance Retrieved Successfully";
    ...
    public static final String REQUEST_FAILURE_MESSAGE_MEETING_NOT_UPDATED = "Failed to update Meeting";
    public static final String REQUEST_FAILURE_MESSAGE_NO_MEETING_FOUND = "No Meeting found";
    public static final String REQUEST_SUCCESS_MESSAGE_MEETING_RETRIEVED = "Meeting Retrieved Successfully";
    ...
    public static final String REQUEST_FAILURE_MESSAGE_PAYMENT_HISTORY_NOT_UPDATED = "Failed to update Payment History";
    public static final String REQUEST_FAILURE_MESSAGE_NO_PAYMENT_HISTORY_FOUND = "No Payment History found";
    public static final String REQUEST_SUCCESS_MESSAGE_PAYMENT_HISTORY_RETRIEVED = "Payment History Retrieved Successfully";
