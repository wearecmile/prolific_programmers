...
public class ApiConstants {
    ...
    public static final String REQUEST_MAPPING_KEY_FIND_GROUP_BY_USER = "/chapter-by-user/{id}";
    public static final String REQUEST_MAPPING_KEY_FIND_USER_BY_GROUP = "/user-by-chapter/{id}";
